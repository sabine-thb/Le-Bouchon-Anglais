...
<body>
    <header>
        ...
        <nav class="mobile-menu">
            <ul>
                <li><a href="index.html" class="burgerLinks">Home</a></li>
                <li><a href="tasting.html" class="burgerLinks">Tastings</a></li>
                <li><a href="services.html" class="burgerLinks">Services</a></li>
                <li><a href="about.html" class="burgerLinks">About</a></li>
        ...
        <div class="nav2">
            ...
            <a href="tasting.html" class="navLink ">Tastings</a>
    ...
    <div class="defilement-container">
        <div class="defilement"
            data-text="Contact-us • Contact-us • Contact-us • Contact-us • Contact-us • Contact-us • Contact-us • ">
            <span class="defilement-span">Contact-us • Contact-us • Contact-us • Contact-us • Contact-us • Contact-us • Contact-us • </span>
        </div>
    </div>
    <div class="dropdown">
        ...
        <div id="dropdownContent" class="dropdown-content">
          <a href="../contact.php" class="fr">French</a>
          <a href="./contact.php" class="en">English</a>
        </div>
    </div>
    <footer>
